<template>
    <div class="search">
        <input type="text" v-model="searchQuery" placeholder="音乐/歌手/专辑"
            @keyup.enter="handleSearch(searchQuery, 30, 0)" />
        <span class="search-icon" @click="handleSearch(searchQuery, 30, 0)">
    ...
    <div v-else class="no-search">
            <div>
                <svg t="1740401874319" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
